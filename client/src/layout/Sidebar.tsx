...
function SidebarNavItem({
  ...
  return (
    <Link
      to={link}
      {...props}
      className={`flex justify-start w-full p-4 rounded-md text-left tracking-wide font-medium hover:bg-accent transition-colors duration-500 ${isActive && 'bg-accent text-primary'}`}
    >
      {icon}
