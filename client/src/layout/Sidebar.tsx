...
export default function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
	...
	return (
		<aside
			...
			className={`border-r fixed top-0 left-0 z-50 h-screen w-72 duration-200 ease-linear shadow-xl transform bg-white ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
				} lg:translate-x-0`}
		>
